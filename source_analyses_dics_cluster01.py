...
for freq,vals in freqs.items():
    ...
    if len(good_cluster_inds):
        ...
        stc_clu_summ.plot(subjects_dir=mri_dir,subject='fsaverage',surface='white',hemi='both',time_viewer=True,spacing='ico5',colormap='coolwarm',clim={'kind':'value','pos_lims':(0,0.5,1)})
    else:
